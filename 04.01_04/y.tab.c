...
static const char *const yytname[] =
{
  ...
  "Multiplication", "Division", "Number", "Equal", "$accept", "input",
  "line", "Exp", YY_NULLPTR
};
...
#line 1140 "y.tab.c"
  ...
  case 9: /* Exp: Exp Multiplication Exp  */
#line 23 "file1.y"
                                         {yyval = yyvsp[-2] * yyvsp[0];}
#line 1146 "y.tab.c"
    break;
...
#line 24 "file1.y"
                                   { 
                    if (yyvsp[0] == 0) {
                        yyval = 0;  // Set result to 0 for division by zero
                    } else {
                        yyval = yyvsp[-2] / yyvsp[0];
                    }
                }
